...
- Name: buttons-functional.spec.js >> Header Buttons - Functional Browser Tests >> Profile button redirects to login when not authenticated
- Location: tests/buttons-functional.spec.js:46:7
